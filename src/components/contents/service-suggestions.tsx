...
const ServiceSuggestions = ({
  ...
  return (
    <div className="bg-primary-50 px-4 py-4 md:px-10 lg:pl-10 lg:py-0 lg:flex-1 lg:h-[344px] lg:mt-0 lg:mb-0 lg:flex lg:items-start lg:flex-col lg:justify-center">
      {showTitle && (

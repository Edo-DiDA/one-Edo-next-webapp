...
const Home = () => {
  return (
    <div>
      <div className="py-[26px] pl-4 pr-[28px] ">
        <Header />
      </div>
      ...
      <div className="md:flex flex-row bg-neutral-800 md:p-20 gap-[5%] min-h-[304px] ">
        <div>
          <div className=" px-4 pt-[24px]  w-full">
            ...
            <p className="font-medium text-neutral-50 text-xs md:text-[18px] mb-[40px]">
        ...
        <div className="w-[50%] px-4 md:px-0">
      ...
      <div className="w-full md:px-20 md:py-10">
        <p className="ml-4 text-xrs text-black font-medium md:text-lg md:text-center pb-6">
          LATEST UPDATES
        </p>
